...
dependencies {
    ...
    //implementation(files("C:/Users/arnav/Desktop/Servers/Titanborn Test Server/plugins/MythicMobs-5.5.1.jar"))
    //compileOnly(files("C:/Users/arnav/Desktop/Servers/Titanborn Test Server/plugins/MythicMobs-5.5.1.jar"))
